...
describe SubscriptionsController do
  ...
  def valid_attributes
    {:user_id => 1, :plan_id => 1, :status => "Active"}
  end
  ...
  describe "GET index" do
    it "assigns all subscriptions as @subscriptions" do
      membership = Subscription.create! valid_attributes
      get :index, {}, valid_session
      assigns(:subscriptions).should eq([membership])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested subscription as @subscription" do
      ...
      assigns(:subscription).should eq(membership)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscription" do
        ...
        put :update, {:id => membership.to_param, :subscription => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested subscription as @subscription" do
        membership = Subscription.create! valid_attributes
        put :update, {:id => membership.to_param, :subscription => valid_attributes}, valid_session
        assigns(:subscription).should eq(membership)
      end
    ...
    describe "with invalid params" do
      it "assigns the subscription as @subscription" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subscription.any_instance.stub(:save).and_return(false)
        put :update, {:id => membership.to_param, :subscription => {}}, valid_session
        assigns(:subscription).should eq(membership)
      end
